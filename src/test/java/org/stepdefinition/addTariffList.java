...
//	}
	...
	driver.findElement(By.name("local_minutes")).sendKeys(map.get(0).get("first"));
	driver.findElement(By.name("local_minutes")).sendKeys(map.get(0).get("second"));
	driver.findElement(By.name("local_minutes")).sendKeys(map.get(0).get("three"));
	driver.findElement(By.name("local_minutes")).sendKeys(map.get(0).get("four"));
	driver.findElement(By.name("local_minutes")).sendKeys(map.get(0).get("five"));
	driver.findElement(By.name("local_minutes")).sendKeys(map.get(0).get("six"));
	driver.findElement(By.name("local_minutes")).sendKeys(map.get(0).get("seven"));
	driver.findElement(By.xpath("//input[@name='submit']")).click(); 
